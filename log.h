...
#define LOG_IMPL_(impl, ctx, fmt, ap) LOG_IMPL(impl, ctx, fmt, ap) __attribute__((__format__(__printf__, 2, 0)))
#else /* !__GNUC__ */
#define LOG_IMPL_(impl, ctx, fmt, ap) LOG_IMPL(impl, ctx, fmt, ap)
#endif /* __GNUC__ */
